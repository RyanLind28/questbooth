      ...
      <div className="container">
        <div className={styles.footerTop}>
          <div className={styles.brand}>
            ...
            <p>Bringing the FUN to your events with epic photo booth experiences!</p>
        ...
        <div className={styles.footerBottom}>
          <p>
            © {currentYear} QuestBooth. Made with <Heart size={14} className={styles.heart} /> by a family who loves parties!
          </p>
        </div>
      </div>
    </footer>
